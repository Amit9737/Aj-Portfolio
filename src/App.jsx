  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-900 via-slate-800 to-slate-900 text-slate-100 antialiased">
      ...
      <header className="sticky top-0 z-40 backdrop-blur-md bg-slate-900/40 border-b border-slate-800">
        <div className="max-w-6xl mx-auto px-6 py-3 flex items-center justify-between">
          ...
          <a href="#home" className="flex items-center gap-3">
            ...
            <div>
              <div className="text-lg font-semibold tracking-tight">Amitbhai Rathod</div>
              <div className="text-xs text-slate-400 -mt-1">Front-end Developer • React</div>
            </div>
          </a>
      ...
      <main className="max-w-6xl mx-auto px-6 py-12">
        {/* HERO */}
        <section id="home" className="grid grid-cols-1 md:grid-cols-12 gap-8 items-center">
          <div className="md:col-span-7">
            ...
            >
              Amit Rathod<span className="text-indigo-400"><br></br>FrontEnd Developer</span>
            </motion.h1>
            ...
            >
              Hi! I'm Amit — a fresher web developer building clean, accessible and animated React interfaces.
              I design small, interview-friendly projects that highlight skills recruiters look for: readability,
            ...
            <div className="mt-8 flex items-center gap-4 text-slate-400">
              <a href="https://github.com/Amit9737" target="_blank" aria-label="github link" className="hover:text-white">
                <Github />
              </a>
              <a href="https://www.linkedin.com/in/amit-rathod-9b236a267/" target="_blank" aria-label="linkedin link" className="hover:text-white">
                <Linkedin />
              </a>
              <a href="https://mail.google.com/mail/u/0/" target="_blank" aria-label="email link" className="hover:text-white">
                <Mail />
              </a>
            </div>
            ...
            >
              ...
              <div className="relative bg-slate-900 p-6 rounded-xl flex flex-col items-center gap-4">
                ...
                <div className="text-center">
                  ...
                  <div className="text-sm text-slate-400">Fresher Front-end Developer</div>
                </div>
                ...
                <div className="w-full mt-2">
                  ...
                  <div className="mt-2 flex flex-wrap gap-2">
                    {skills.slice(0, 4).map((s) => (
                      <span key={s} className="text-xs px-2 py-1 bg-white/5 rounded-md">{s}</span>
                    ))}
                  </div>
                </div>

                <div className="w-full flex items-center gap-3 mt-4">
                  <a href={ResumePDF}  className="flex-1 inline-flex items-center justify-center gap-2 px-3 py-2 rounded-md bg-indigo-600" target="_blank">
                    <Download size={16} /> Download Resume
                  </a>

                  <a href="#contact" className="inline-flex items-center px-3 py-2 rounded-md border border-slate-700">
                    Message
                  </a>
                </div>
              </div>
        ...
        <section id="about" className="mt-16">
          ...
          <motion.div
            ...
            viewport={{ once: true }}
          >
            I'm a fresher web developer focused on building responsive, accessible and animated user
            interfaces using modern tools like React and Tailwind CSS. I enjoy turning UI designs into
            production-ready components and learning new libraries to ship polished results.
          </motion.div>
        </section>
        ...
        <section id="projects" className="mt-12">
          <div className="flex items-center justify-between">
            ...
            <a href="#projects" className="text-sm text-indigo-400 hover:underline">
              See all
            </a>
          </div>
                ...
                <div className="flex items-start gap-4">
                  <div className="flex-1">
                    ...
                    <div className="mt-3 flex flex-wrap gap-2">
                      {p.tech.map((t) => (
                        <span key={t} className="text-xs px-2 py-1 bg-white/5 rounded-md">{t}</span>
                      ))}
                    </div>
                  </div>

                  <div className="flex-shrink-0 flex items-center gap-2">
                    <a href={p.repo} className="text-sm px-3 py-2 rounded-md border border-slate-700">Repo</a>
                    <a href={p.demo} className="text-sm px-3 py-2 rounded-md bg-indigo-600">Demo</a>
                  </div>
                </div>
              </motion.article>
            ))}
        ...
        <section id="contact" className="mt-12">
          ...
          <div className="mt-4 grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="md:col-span-2">
              <form ref={form} onSubmit={sendEmail} className="grid grid-cols-1 gap-4" id="ContactForm">
                <input
                  type="text"
                ...
                <div className="flex items-center gap-3">
                  <button type="submit" onClick={sendEmail} className="px-4 py-2 rounded-lg bg-indigo-600">Send Message</button>
                  <button type="button" className="px-4 py-2 rounded-lg border">Clear</button>
                </div>
              </form>
            </div>
            ...
            <aside className="p-6 rounded-lg bg-slate-800/50 border border-slate-700">
              ...
              <div className="font-medium">Internships · Junior Roles · Freelance</div>

              <div className="mt-6 flex items-center gap-3 text-slate-300">
                <a target="_blank" href="https://github.com/Amit9737"> <Github /> </a>
                <a target="_blank" href="https://www.linkedin.com/in/amit-rathod-9b236a267/"> <Linkedin /> </a>
                <a target="_blank" href="https://www.gmail.com"> <Mail /> </a>
              </div>
            </aside>
          </div>
        </section>
        ...
        <footer className="mt-16 py-8 border-t border-slate-800/60 text-slate-400 text-sm">
          <div className="max-w-6xl mx-auto px-6 flex flex-col md:flex-row items-center justify-between">
            <div>© {new Date().getFullYear()} Amitbhai Rathod. Built with React + Tailwind.</div>
            <div className="mt-3 md:mt-0">Designed for recruiters • One-page friendly</div>
          </div>
        </footer>
      </main>
    </div>
