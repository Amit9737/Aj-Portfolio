...
import NSDCCertificateImage from "./assets/CertificatesImage&Pdf/NSDC_Certificate.png";
import TOPSCertificateImage from "./assets/CertificatesImage&Pdf/TOPS_Certificate.png";
import NSDCCertificatePdf from "./assets/CertificatesImage&Pdf/nsdc_certificate_23037.pdf";
import TOPSCertificatePdf from "./assets/CertificatesImage&Pdf/tops_certificate_45046.pdf";
import GraduationCertificateImage from "./assets/CertificatesImage&Pdf/Graduation.jpeg";
import GraduationCertificatePdf from "./assets/CertificatesImage&Pdf/Graduation-Certificate.pdf";
...
const FrontEndNSDCImage = NSDCCertificateImage;
const FrontEndNSDCPdf = NSDCCertificatePdf;
const FrontEndTOPSImage = TOPSCertificateImage;
const FrontEndTOPSPdf = TOPSCertificatePdf;
const BCAGraduationCertificateImage = GraduationCertificateImage;
const BCAGraduationCertificatePdf = GraduationCertificatePdf;
...
const Certificates = [
  {
    title: "FrontEnd Developer NSDC Certificate",
    image: FrontEndNSDCImage,
    path: FrontEndNSDCPdf,
  },
  {
    title: "FrontEnd Developer TOPS Certificate",
    image: FrontEndTOPSImage,
    path: FrontEndTOPSPdf,
  },
  {
    title: "Graduation Certificate",
    image: BCAGraduationCertificateImage,
    path: BCAGraduationCertificatePdf,
  },
];
  ...
  const projects = [
    {
      ...
      demo: navigate("/UnderConstrunction"),
        ...
        <main className="max-w-6xl mx-auto px-6 py-12">
          ...
          >
            <div className="md:col-span-7">
              ...
              >
                Hi! I'm Amit — a fresher web developer building clean,
                accessible and animated React interfaces. I design small,
                interview-friendly projects that highlight skills recruiters
                look for: readability, responsive UI, and deployment-ready code.
              </motion.p>
            ...
            <div className="mt-4 grid grid-cols-2 sm:grid-cols-3 md:grid-cols-6 gap-3">
              {skills.map((s) => (
                <motion.div
                  ...
                  key={s}
                  className="p-3 bg-slate-900/60 rounded-lg text-sm text-center"
                >
                  {s}
                </motion.div>
              ))}
